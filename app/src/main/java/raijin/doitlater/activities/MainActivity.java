...
public class MainActivity extends AppCompatActivity
    ...
    private void initializeFirstView() {
        ...
        if (currentFragment == FragmentType.TODO) {
            screenManager.openFragment(new ToDoFragment().create(this.screenManager), false);
            navigationView.getMenu().getItem(0).setChecked(true);
        } else if (currentFragment == FragmentType.COMPLETED) {
            screenManager.openFragment(new CompletedFragment().create(this.screenManager), false);
            navigationView.getMenu().getItem(1).setChecked(true);
        } else if (currentFragment == FragmentType.ALLTASK) {
            screenManager.openFragment(new AllTasksFragment().create(this.screenManager), false);
    ...
    private void doSearch(String searchString) {
        FragmentWithSearch fragmentWithSearch =
                (FragmentWithSearch) getSupportFragmentManager().
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.to_do_menu_item) {
            ...
            screenManager.openFragment(new About().create(this.screenManager), false);
    ...
    public static class SettingsFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            settings = getPreferenceManager().getDefaultSharedPreferences(getActivity());
        }
