                        ...
                        switch (item.getItemId()) {
                            case R.id.context_menu_delete:
                                ...
                                if (currentFragment == FragmentType.ALLTASK) {
                                    realmHandle.deleteNoteFromRealm(realmHandle.getAllNoteFromRealm().get(position));
                                    ...
                                    realmHandle.deleteNoteFromRealm(realmHandle.getToDoNotefromRealm().get(position));
                                }
